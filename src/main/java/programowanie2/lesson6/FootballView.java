    ...
    public FootballView() {
        addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                switch (e.getKeyCode()) {
                    case KeyEvent.VK_NUMPAD8: presenter.moveTop();break;
                    case KeyEvent.VK_NUMPAD9: presenter.moveTopRight();break;
                    case KeyEvent.VK_NUMPAD6: presenter.moveRight();break;
                    case KeyEvent.VK_NUMPAD3: presenter.moveBottomRight();break;
                    case KeyEvent.VK_NUMPAD2: presenter.moveBottom();break;
                    case KeyEvent.VK_NUMPAD1: presenter.moveBottomLeft();break;
                    case KeyEvent.VK_NUMPAD4: presenter.moveLeft();break;
                    case KeyEvent.VK_NUMPAD7: presenter.moveTopLeft();break;
                }
            }
        });
    }
